    ...
    <div class="row justify-content-between">
        ...
        <div class="row justify-content-end">
            <div class="col-lg-4 mb-1">
                <select wire:model='carikelas' class="form-control">
    ...
    <table class="table table-striped">
        ...
        @foreach ($data as $d)
            <tr>
                ...
                <td>{{ $d->nama_ujian }}</td>
                <td>
                    <a class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#k_hapus" wire:click="k_hapus({{ $d->id_logc }})"><i class="fa fa-trash"></i> Hapus Log</a>
                </td>
            </tr>
        @endforeach
    </table>
